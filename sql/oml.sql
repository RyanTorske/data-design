...
SELECT videoId, videoProfileId, videoDate, videoDescription FROM video WHERE videoProfileId= (UNHEX('3ed2910c4fcc49d9a90e569e50043e9d'));

SELECT video.videoId, profile.profileId FROM video INNER JOIN profile on video.videoProfileId = profile.profileId WHERE videoDescription = 'blablablablablabla';

DELETE FROM video WHERE videoProfileId = (UNHEX('88a6dc5fb1324144be251e74787910e1'));